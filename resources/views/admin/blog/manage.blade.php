        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">All Blogs Data</h4>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($item->category->blog_category) ? $item->category->blog_category: '' }}</td>
                                    <td>{{ $item->blog_title }}</td>
                                    <td>{{ $item->blog_tags }}</td>
                                    <td><img src="{{ asset($item->blog_image) }}" alt="" style="width:60px; height:50px;"></td>
                                    <td>
                                        <a href="{{ route('blog.edit', $item->id) }}" class="btn btn-info btn-sm" title="Edit Data">
