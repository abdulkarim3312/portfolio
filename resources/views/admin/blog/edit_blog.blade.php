                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('blog.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="blog_category_id" aria-label="Default select example">
                                        ...
                                        <option value="{{ $data->id }}" {{ $data->id == $blog->blog_category_id ? 'selected' : '' }}>{{ $data->blog_category }}</option>
                                        @endforeach
                                        </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="blog_title" value="{{ $blog->blog_title }}" type="text"  id="example-text-input">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ $blog->blog_tags }}" name="blog_tags" type="text" data-role="tagsinput">
